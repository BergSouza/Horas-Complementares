        ...
        <View style={style.container}>
            ...
            <View style={style.blocoGeral}>
                ...
                <View style={style.bloco3}>
                    ...
                    <View  style={poltronas[47][0] == 1 ? [style.poltrona, style.poltronaOcupada] : style.poltrona}><Text onPress={() => {setPoltronaSelecionada(43)}} style={style.textButton}>48</Text></View>
                </View>
                ...
                <View style={style.bloco4}>
                    ...
                    <View  style={poltronas[46][0] == 1 ? [style.poltrona, style.poltronaOcupada] : style.poltrona}><Text onPress={() => {setPoltronaSelecionada(42)}} style={style.textButton}>47</Text></View>
                </View>
            </View>
        </View>
    )
